...
$this->title = 'Berkas Keluar Sukses';
...
<?php
$autocompleteUrl = Url::to(['search-sukses']);
...
const searchInput = document.getElementById('search_keluar_sukses');
const resultsBox  = document.getElementById('autocomplete-results');
const searchForm  = document.getElementById('form-search-keluar-sukses');
