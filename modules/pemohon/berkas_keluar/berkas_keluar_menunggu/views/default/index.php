...
$this->title = 'Berkas Keluar Menunggu';
        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex justify-content-start align-items-center flex-wrap gap-2 mb-4">
                <?= Html::beginForm(['index'], 'get', [
                    'id' => 'form-search-keluar-menunggu',
...
<?php
$autocompleteUrl = Url::to(['search-menunggu']);
...
// Autocomplete
const searchInput = document.getElementById('search_keluar_menunggu');
const resultsBox  = document.getElementById('autocomplete-results');
const searchForm  = document.getElementById('form-search-keluar-menunggu');
