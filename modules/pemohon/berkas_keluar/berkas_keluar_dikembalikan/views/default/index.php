...
$this->title = 'Berkas Keluar Dikembalikan';
        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex justify-content-start align-items-center flex-wrap gap-2 mb-4">
                <?= Html::beginForm(['index'], 'get', [
                    'id' => 'form-search-keluar-dikembalikan',
                            ...
                            <?php if ($dataProvider->totalCount > 0): ?>
                                <?php foreach ($dataProvider->getModels() as $index => $model): ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?= Html::encode($model['tanggal_ditolak'] ?? '') ?></td>
                                        <td><?= Html::encode($model['kategori'] ?? '') ?></td>
...
<?php
$autocompleteUrl = Url::to(['search-dikembalikan']);
...
// Autocomplete Outbox Dikembalikan
const searchInput = document.getElementById('search_keluar_dikembalikan');
const resultsBox = document.getElementById('autocomplete-results');
const searchForm = document.getElementById('form-search-keluar-dikembalikan');
