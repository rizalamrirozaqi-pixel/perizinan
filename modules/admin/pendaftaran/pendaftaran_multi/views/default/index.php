            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-lg-4 mb-3">
                ...
                <a href="<?= Url::to(['form-daftar']) ?>" class="btn btn-outline-primary py-1 px-2 px-sm-4 fs-14 fw-medium rounded-3 hover-bg d-flex align-items-center">
                    <span class="py-sm-1 d-block d-flex align-items-center">
                        ...
                        <span>Tambah Multi Pendaftaran</span>
                    </span>
                </a>
            </div>
                            ...
                            <table class="table align-middle">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-nowrap" scope="col">Nomor KTP</th>
                                        <th class="text-nowrap" scope="col">Nomor KK</th>
                                        ...
                                        <th class="text-nowrap" scope="col">Waktu Daftar</th>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($models as $index => $model): ?>
                                        <tr>
                                            ...
                                            <td class="text-secondary"><?= Html::encode($model['no_ktp']) ?></td>
                                            <td class="text-secondary"><?= Html::encode($model['no_kk']) ?></td>
...
<?php
// PERUBAHAN DI SINI:
// Mengganti script tooltip Anda dengan registerJs
// yang berisi Tooltip DAN SweetAlert untuk Hapus
$csrfParam = Yii::$app->request->csrfParam;
$csrfToken = Yii::$app->request->csrfToken;

$jsDelete = <<<JS

// 1. Inisialisasi Tooltip (dari script Anda sebelumnya)
var tooltipTriggerList = [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'))
var tooltipList = tooltipTriggerList.map(function (tooltipTriggerEl) {
  return new bootstrap.Tooltip(tooltipTriggerEl)
});

// 2. Handler untuk tombol hapus di halaman index
$('.btn-hapus-data').on('click', function(event) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            // Buat form dinamis untuk mengirim POST
