 ...
 * @var array $modelJadwal Data jadwal (surat tugas)
...
<body>
    ...
    <button onclick="window.print()" class="btn-print" style="position:fixed; top:10px; right:10px; padding: 5px 10px; cursor:pointer;">Cetak</button>
    ...
    <table class="info-table">
        <tr>
            ...
            <td>Tanggal</td>
            <td>:</td>
            <!-- Menggunakan tanggal cetak surat tugas -->
            <td><?= Html::encode(Yii::$app->formatter->asDate($modelJadwal['tanggal_cetak'] ?? 'now', 'php:Y-m-d H:i:s')) ?></td>
        </tr>
        <tr>
            <td>Nama Izin</td>
            <td>:</td>
        ...
        <tr>
            ...
            <td></td>
            <td></td>
            <!-- Menggunakan tim pemeriksa dari surat tugas -->
            <td>Verifikator</td>
            <td>:</td>
            <td><?= Html::encode($modelJadwal['tim_peninjau'] ?? '-') ?></td>
        </tr>
    </table>
