...
$this->title = 'Register Pendaftaran';
?>
    ...
    <div class="card bg-white border-0 rounded-3 mb-4 shadow-sm">
        <div class="card-body p-4">
            ...
            <div class="mb-4">
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        <label class="form-label fw-medium text-secondary small mb-1">Status Pendaftaran</label>
                        <?= Html::dropDownList('status_pendaftaran', $params['status_pendaftaran'] ?? 'OFFLINE', ['OFFLINE' => 'OFFLINE', 'ONLINE' => 'ONLINE'], [
                ...
                <div class="row mb-3">
                    <div class="col-md-12 d-flex align-items-end justify-content-start gap-2">
                        ...
                        <button type="submit"
                            ...
                            <i class="material-symbols-outlined fs-18">print</i> Cari (Cetak HTML)
                        </button>

                        <button type="submit"
                            formaction="<?= Url::to(['export-excel']) ?>"
                            formtarget="_self"
                            class="btn btn-outline-success px-3 py-2 d-flex align-items-center gap-2">
                            <i class="material-symbols-outlined fs-18">table_view</i> Cari (Cetak EXCEL)
                        </button>
