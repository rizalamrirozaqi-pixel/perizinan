...
// Judul Halaman
$this->title = 'Laporan Perizinan Online';
    ...
    <div class="card bg-white border-0 rounded-3 mb-4 shadow-sm">
        <div class="card-body p-4">
            ...
            <div class="col-md-12 d-flex align-items-end justify-content-start gap-2">
                <button type="submit" class="btn btn-primary btn-sm px-3 py-2">Cetak</button>
            </div>
            ...
            <div class="default-table-area all-products">
                <div class="table-responsive">
                    <table class="table align-middle">
                        ...
                        <thead class="text-center fw-bold align-middle" style="background-color: #f8f9fa;">
                            <tr>
                                <th rowspan="2" width="3%">No</th>
                                <th rowspan="2">Jenis Izin</th>
                                <th colspan="4" class="">s/d Bulan <?= $namaBulanLalu ?></th>
                                <th colspan="4" class="">Bulan <?= $namaBulan ?></th>
                                <th colspan="4" class="">s/d Bulan <?= $namaBulan ?></th>
                            </tr>
                            <tr>
                                <?php for ($i = 0; $i < 3; $i++): ?>
                                    <th width="5%">Masuk</th>
