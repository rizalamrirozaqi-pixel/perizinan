...
$this->title = 'Login Pemohon - Perizinan';
...
<head>
    ...
    <style>
        ...
        .left-panel {
            background-image: url('<?= Yii::getAlias('@web') ?>/images/pemohon-bg.jpg');
            /* Ganti gambar */
        ...
        <div class="row g-0 vh-100">
            ...
            <div class="col-lg-6 d-none d-lg-flex flex-column justify-content-center align-items-center left-panel text-white position-relative" style="background-image: url(<?= Yii::getAlias('@web') ?>/images/login.jpg);">
                ...
                <div class="position-relative z-1 text-center px-5">
                    ...
                    <h2 class="fw-bold mb-3 text-white">Selamat Datang di Layanan Perizinan</h2>
                    <p class="fs-18">Ajukan izin Anda secara online, mudah, dan transparan.</p>
                </div>
            </div>

            <!-- Bagian Kanan (Form Login) -->
            <div class="col-lg-6 d-flex justify-content-center p-4 p-md-5 vh-100 overflow-auto">
                <div class="mw-480 w-100">

                    <div class="text-center mb-4">
                        <img src="<?= Yii::getAlias('@web') ?>/images/diginet.png" class="w-25 mb-3" alt="Logo">
                        <h3 class="fs-24 fw-bold">Login Executive Summary</h3>
                        <p class="text-muted">Lengkapi data diri anda untuk masuk.</p>
                    </div>
                    ...
                    <?= $form->field($model, 'username')->textInput(['placeholder' => 'Masukkan Email / NIK', 'autofocus' => true])->label('Email / NIK') ?>

                    <?= $form->field($model, 'password')->passwordInput(['placeholder' => 'Masukkan Password'])->label('Password') ?>

                    <!-- CAPTCHA Sederhana (Client Side) -->
                    <div class="mb-4">
                        <label class="form-label fw-medium">Verifikasi Keamanan</label>
                        <div class="d-flex gap-2 mb-2">
                            <div id="captcha-box" class="bg-light border rounded py-2 px-4 fw-bold fs-20 text-secondary text-decoration-line-through user-select-none" style="letter-spacing: 5px;">
                                <!-- Captcha Code Here -->
                            </div>
                            <button type="button" class="btn btn-outline-secondary" id="reload-captcha" title="Refresh Captcha">
                                <i class="material-symbols-outlined">refresh</i>
                            </button>
                        </div>
                        <input type="text" id="captcha-input" class="form-control h-55" placeholder="Ketik kode di atas" required>
                        <div id="captcha-error" class="text-danger fs-12 mt-1 d-none">Kode verifikasi salah!</div>
                    </div>

                    <div class="form-group mb-4">
                        <?= Html::submitButton(
                            '<div class="d-flex align-items-center justify-content-center py-1">
                                <i class="material-symbols-outlined me-2 fs-20 text-white">login</i> 
                                <span>Login</span>
                            </div>',
                            [
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <a href="<?= Url::to(['/admin/login']) ?>" class="btn btn-outline-primary fw-medium py-2 px-3 w-100 d-flex align-items-center justify-content-center hover-bg mb-3">
                                <i class="material-symbols-outlined fs-20 me-2">admin_panel_settings</i>
                                <span>Admin</span>
                            </a>
                        </div>
            ...
            form.addEventListener('submit', function(e) {
                ...
                if (userInput === "") {
                    Swal.fire({
                        ...
                        text: 'Silakan isi kode nya dulu ya.',
                    });
                    return;
                }
